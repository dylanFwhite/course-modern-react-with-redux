...
function SortableTable(props) {
    ...
    if (sortOrder && sortBy) {
        ...
        // Make a copy of data before sorting because must always avoid
        // modifying props outside of `setSate()`
    ...
    // Becasue we list config prop after `...props` the existing one will be
    // overwritten
